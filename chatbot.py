...
from utils import load_tsv, compute_softmax_metrics

import wandb

wandb.init(project="BERT", entity="lora")
...
def main():
    ...
    if args.pretrain == "BERT":
        ...
        trainer = Trainer(model=model, args=training_args, train_dataset=train_dataset, eval_dataset=dev_dataset, compute_metrics=compute_softmax_metrics)
        trainer.train()
        ...
        train_input_features = [ [] ] * len(train_labels)
