...
wandb.init(project="depth", entity="lora")
...
def main():
    ...
    training_args = TrainingArguments("depth-output", num_train_epochs=args.num_epoch, evaluation_strategy="epoch", learning_rate = args.learning_rate, report_to="wandb")
