...
wandb.init(project="width", entity="lora")
...
def main():
    ...
    model = AutoModelForSequenceClassification.from_pretrained("microsoft/DialogRPT-width")
    ...
    training_args = TrainingArguments("width-output", num_train_epochs=args.num_epoch, evaluation_strategy="epoch", learning_rate = args.learning_rate, report_to="wandb")
